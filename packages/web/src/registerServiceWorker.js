        ...
        installingWorker.onstatechange = () => {
          ...
          if (installingWorker.state === 'installed') {
            if (navigator.serviceWorker.controller) {
              ...
              if (window.location.search.indexOf('swrefreshed') > -1) {
                return;
              }
              const refreshDestination = appendQueryParameter(window.location.href, [
                'autoplay=no',
                'swautoplay=yes',
                'swrefreshed=' + Date.now().toString(),
              ]);
              const serviceWorkerUpdatingScreen = document.getElementById(
                'serviceWorkerUpdatingScreen'
              );
