 ...
 *
 * @file   This file exports the following functions for use with enzyme: shallowWithIntl, mountWithIntl
...
const messages = require('../../../../xi-core/translations/en.json'); // en.json
